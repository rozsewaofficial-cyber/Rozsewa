...
import {
  ...
  MoreVertical, X, FileText, CreditCard, Camera
} from "lucide-react";
                    ...
                    <td className="py-5 px-6 text-right">
                      <div className="flex items-center justify-end gap-2.5">
                        ...
                        <button
                          ...
                          className="inline-flex items-center justify-center rounded-lg bg-gray-50 text-gray-500 p-2 border border-gray-200 hover:bg-gray-200 transition-all shadow-sm"
                          title="View Details"
                        >
