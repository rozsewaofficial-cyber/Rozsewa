        ...
        handler: async (response) => {
          try {
            ...
            if (verification.success) {
              toast({
                title: "Money Added! 🎉",
                description: `₹${amount} successfully added to your wallet.`,
              });
              setAddAmount("");
      ...
      <main className="container max-w-2xl px-4 py-6 space-y-6">
        ...
        >
          ...
          <div className="relative z-10 flex justify-between items-start">
            <div>
              <p className="text-[9px] font-black opacity-80 uppercase tracking-widest text-blue-100 mb-0.5">
                Available Balance
              </p>
              <h2 className="text-4xl font-black flex items-center gap-1 tracking-tight">
            ...
            <motion.button
              ...
              onClick={() =>
                toast({
                  title: "Notice",
                  description:
                    "Withdrawal is temporarily disabled for standard accounts.",
                })
              }
        ...
        <div className="grid grid-cols-2 gap-3 md:gap-4">
          <div className="rounded-3xl border border-border bg-gradient-to-br from-card to-muted/30 p-4 md:p-5 flex flex-col items-start gap-3 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
            ...
            <div className="min-w-0 mt-1 relative z-10">
              <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest mb-1 opacity-80">
                Total Earned
              </p>
              <p className="text-xl md:text-2xl font-black text-foreground tracking-tight truncate">
              ...
              displayTransactions.map((txn, i) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    <div
                      className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border ${txn.type === "credit" ? "border-emerald-200 bg-emerald-50 text-emerald-600 dark:border-emerald-900/30 dark:bg-emerald-900/20" : "border-rose-200 bg-rose-50 text-rose-600 dark:border-rose-900/30 dark:bg-rose-900/20"}`}
                    >
                      {txn.type === "credit" ? (
                  ...
                  <p
                    className={`font-black text-base tabular-nums ${txn.type === "credit" ? "text-emerald-500" : "text-rose-500"}`}
                  >
                    {txn.type === "credit" ? "+" : "-"}₹
